...
<script type="text/javascript">
	$(function() {
		...
		var chkMemId = ""; // 중복체크 할 때의 ID가 저장될 벼녀수
...
<table border="1">
	<tr>
		<td>회원ID</td>
		<td><input type="text" name="mem_id" id="mem_id"><input type="button" value="중복확인" id="idCheck"><br><span id="idChkResult"></span></td>
	</tr>
	<tr>
		<td>회원이름</td>
