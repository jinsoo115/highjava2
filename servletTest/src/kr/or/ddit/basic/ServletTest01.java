...
/*
 * 이 예제는 배포서술자(DD, Deployment Descriptor ==> web.xml)를
...
public class ServletTest01 extends HttpServlet {
	...
	// 이 부분의 영역에서는 service()메서드 또는 doGet()메서드나
	// doPost()메서드를 재정의 해서 작성한다.
	
	// doGet()메서드나 doPost()메서드는 service()메서드를 통해서 호출된다.
	
	// doGet()메서드와 doPost()메서드의 매개변수들
	// 1. HttpServletRequest객체 ==> 서비스 요청에 관련된 정보 및 메서드
	// 				관리하는 객체
	// 2. HttpServletResponse객체 ==> 서비스 응답에 관련된 정보 및
	//				메서드를 관리하는 객체
	//-----------------------------------------------------
