...
public class SessionReadServlet extends HttpServlet {
	...
	*/
	...
	/*
	 2. geAttribute()메서드를 이용해서 저장된 session값을 읽어온다.
	 형식) session객체.getAttribute("key값");
	 	==> 반환되는 값은 object형이기 때문에 원래의 자료형으로 형변환해서 사용한다.
	 */
		...
		out.println("<h3>세션 데이터 1개씩 확인하기");
		...
		out.println("<h3> 전체 섹션 데이터 확인하기 </h3>");
		out.println("<ol>");
		// 세션에 저장된 전체 key 값들을 가져온다.
